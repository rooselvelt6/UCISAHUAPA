class Glasgow():
	...
	La peor en las primeras 24 horas de UCI, antes de sedacion. """
		...
		try:
			...
			if((valor >= 1) and (valor <= 4)):
				...
				if(self.datos["valor"] == 1):
					...
					self.datos["observacion"] = "Espontanea"
		...
		try:
			...
			# ANOTACION DE LA OBSERVACION
				...
				if(self.datos["valor"] == 1):
					...
					self.datos["observacion"] = "Postura en extension"

				elif(valor == 3):

					self.datos["observacion"] = "Postura en flexion"
					...
					self.datos["observacion"] = "Localiza estimulos"

				elif(valor == 6):

					self.datos["observacion"] = "Obedece ordenes"
	...
	def respuesta_verbal(self, valor=1):
		...
		try:
			...
			if((valor >= 1) and (valor <= 5)):
				...
				self.datos = {} # hash de informacion
